...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
          ...
          <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
              <a href="#" class="dropdown-item">
                ...
                <div class="d-flex">
                  <div class="flex-shrink-0">
                    <img src="{{ asset('/css/assets/img/user1-128x128.jpg') }}" alt="User Avatar"
              ...
              <a href="#" class="dropdown-item">
                ...
                <div class="d-flex">
                  <div class="flex-shrink-0">
                    <img src="{{ asset('/css/assets/img/user8-128x128.jpg') }}" alt="User Avatar"
                      class="img-size-50 rounded-circle me-3" />
                  </div>
                  <div class="flex-grow-1">
                    <h3 class="dropdown-item-title">
              ...
              <a href="#" class="dropdown-item">
                ...
                <div class="d-flex">
                  <div class="flex-shrink-0">
                    <img src="{{ asset('/css/assets/img/user3-128x128.jpg') }}" alt="User Avatar"
                      class="img-size-50 rounded-circle me-3" />
                  </div>
                  <div class="flex-grow-1">
                    <h3 class="dropdown-item-title">
      ...
      <div class="sidebar-brand">
        ...
        <a href="./index.html" class="brand-link">
          ...
          <img {{-- src="../../dist/assets/img/AdminLTELogo.png" --}}
            src="{{ asset('/css/assets/img/AdminLTELogo.png') }}" alt="AdminLTE Logo"
  ...
  <script src="{{ asset('/css/adminlte.js') }}"></script>
